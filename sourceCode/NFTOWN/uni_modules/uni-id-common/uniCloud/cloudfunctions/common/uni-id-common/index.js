...
class A {
  constructor({
    ...
    this._clientInfo = e ? function(e) {
        ...
        "custom-token.js") && this.setInterceptor("customToken", require(w.resolve("custom-token.js"))), this._i18n =
      uniCloud.initI18n({
  ...
  _getPlatformConfig() {
    ...
    let t;
    switch ("app-plus" === this._clientInfo.platform && (this._clientInfo.platform = "app"), "h5" === this._clientInfo
      .platform && (this._clientInfo.platform = "web"), this._clientInfo.platform) {
      case "web":
        t = "h5";
        break;
      case "app":
